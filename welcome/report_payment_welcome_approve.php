            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="modal-header">
                  <h1 class="modal-title" style="float: left;">Report Of Citizen Payment Welcome Approved</h1>    
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {    
                        ...
                        <tr>
                          ...
                          <a href="restoreapprovewel.php?paywel_id=<?php echo ($row->paywel_id);?>" onclick="return confirm('Do you really want to Restore ?');" title="Block this User">Restore</a> </td>                      
                          </td>.
