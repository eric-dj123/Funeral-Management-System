...
if(isset($_POST['login']))
{
    ...
    $sql ="SELECT * FROM welcomeuser_tbl WHERE email=:email and password=:password";
    ...
    if($query->rowCount() > 0)
    {
        ...
        {
            $_SESSION['odmsaid']=$result->welcomeuser_id;
        ...
        $aa= $_SESSION['odmsaid'];
        $sql="SELECT * from welcomeuser_tbl  where welcomeuser_id=:aa";
        $query = $dbh -> prepare($sql);
                        ...
                        <div class="auth-form-light text-left p-5">
                            ...
                            <img class="img-avatar" src="companyimages/deco1.png" alt="">
                                <h4 class="text-muted mt-4">
                                    Wecome to Welcome User Login Page
                                </h4>
                            </div>
