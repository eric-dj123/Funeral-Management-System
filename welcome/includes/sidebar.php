    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                ...
                <li class="nav-item"> <a class="nav-link" href="manage_welcome_payment.php">Manage Payment</a></li>
                <li class="nav-item"> <a class="nav-link" href="report_payment_welcome_approve.php">Approved Payment</a></li>
                    <li class="nav-item"> <a class="nav-link" href="report_payment_welcome_canceled.php">Cancelled Canceled</a></li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="reports">
                ...
                <li class="nav-item"> <a class="nav-link" href="payment_welcome_report.php">Payment reports</a></li>
