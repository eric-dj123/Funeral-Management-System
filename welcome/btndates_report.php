            ...
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                ...
                <div class="modal-body" id="info_update4">
                 <?php @include("view_newpaymentwelcome.php");?>
               </div>
            ...
            <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
              <thead>
                <tr>
                  ...
                  <th class="d-none d-sm-table-cell">Welcome Name Payed</th>
              ...
              <tbody>
                <?php
               $sql="SELECT * from paymentwel_tbl ,citizenuser_tbl,welcome_tbl where date( 	payed_on) between '$fdate' and '$tdate' AND  citizenuser_tbl.citizenuser_id = paymentwel_tbl.citizenuser_id AND welcome_tbl.welcome_id = paymentwel_tbl.welcome_id
               AND paymentwel_tbl.status='1'";
                  ...
                  foreach($results as $row)
                    {               ?>
                      <tr>
                        ...
                        <td class=" text-center"><a href="#"  class=" edit_data4" id="<?php echo  ($row->paywel_id); ?>" title="click to edit"><i class="mdi mdi-eye" aria-hidden="true"></i></a>
                        <a href="invoice_generating.php?invid=<?php echo htmlentities ($row->paywel_id);?>"><i class="mdi mdi-printer" aria-hidden="true"></i></a>
                      </tr>
                      <?php
                      $cnt=$cnt+1;
                    }
                  ...
                  foreach($results as $row)
                    {               ?>
                      ...
                      <td class="text-center"><?php echo htmlentities($cnt);?></td>
                        ...
                        <td class="font-w600"><?php  echo htmlentities($row->lastname);?></td>
                        <td class="font-w600"><?php  echo htmlentities($row->phonenumber);?></td>
                        <td class="font-w600"><?php  echo htmlentities($row->welcomename);?></td>
...
<script type="text/javascript">
  $(document).ready(function(){
    $(document).on('click','.edit_data4',function(){
      ...
      $.ajax({
        url:"view_newpaymentwelcome.php",
        type:"post",
