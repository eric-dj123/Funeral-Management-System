...
<section class="ftco-section bg-light">
  <div class="container">
    ...
    <div class="row">
      <?php
     $sql="SELECT * from cemetery_tbl where category='First Category' ";
          ...
          <div class="col-md-6 col-lg-3 ftco-animate" style="margin-bottom: 50px;">
            <div class="block-7">
              <div class="text-center">
                ...
                <a href="book_services.php?bookid=<?php echo $row->cemetery_id;?>" class="btn btn-danger px-4 py-3">Continue</a>
              </div>
            </div>
          </div>
          <?php 
