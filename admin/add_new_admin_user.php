                        ...
                        <div class="card">
                            ...
                            <div class="modal fade" id="registeruser">
                                <div class="modal-dialog ">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Register Admin User</h4>
                            ...
                            <div class="card-body table-responsive p-3">
                                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql="SELECT * from admin_tbl where status='0' ";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            ...
                                            {    
                                                ...
                                                <tr>
                                                    ...
                                                    <td class=" text-center">
                                                        <a href="#"  class=" edit_data" id="<?php echo  ($row->admin_id); ?>" title="click for edit"><i class="mdi mdi-pencil-box-outline" aria-hidden="true"></i></a>
                                                        <a href="add_new_admin_user.php?delid=<?php echo ($row->admin_id);?>" onclick="return confirm('Do you really want to block user ?');" title="Block this User">Block</a> </td>
                                                    </tr>
                                                    <?php $cnt=$cnt+1;
                                                }
                                            } ?>
