...
if(isset($_GET['restoreid']))
{
    ...
    $sql="update companyuser_tbl set status='0' where companyuser_id='$rid'";
...
<div class="card-body table-responsive p-3">
    ...
    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
        ...
        <tbody>
            <?php
            $sql="SELECT * from companyuser_tbl where status='1' ";
            $query = $dbh -> prepare($sql);
            $query->execute();
            ...
            if($query->rowCount() > 0)
            {
                ...
                {    
                    ...
                    <tr>
                        ...
                        <td class=""><a href="deleted_company_user.php?restoreid=<?php echo ($row->companyuser_id);?>" onclick="return confirm('Do you really want to Restore user ?');" title="Restore this User">restore</i></a> </td>
                    </tr>
                    <?php $cnt=$cnt+1;
                }
            } ?>
