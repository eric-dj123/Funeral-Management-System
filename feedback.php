                ...
                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                  <thead>
                    <tr>
                      ...
                      <th class="">Feedback Description</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                    $sql="SELECT * from prayerrquest_tbl where citizenuser_id='".$_SESSION['odmsaid']."'";
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {    
                        ?>
                        <tr>
                        <td class=""><?php  echo htmlentities($row->request_id);?></td>
                        
                          <td class=""><?php  echo htmlentities($row->comment);?></td>
