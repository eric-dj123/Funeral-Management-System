...
if(isset($_GET['delid']))
{
    ...
    $sql="update admin_tbl set status='0' where admin_tbl='$rid'";
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            ...
                                            {    
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php  echo htmlentities($row->added_on);?></td> 
                                                    </td>
                                                    <td class=" text-center">
                                                        ...
                                                        <a href="userregister.php?delid=<?php echo ($row->admin_id);?>" onclick="return confirm('Do you really want to block user ?');" title="Block this User">Block</a> </td>
                                                    </tr>
                                                    <?php $cnt=$cnt+1;
                                                }
                                            } ?>
