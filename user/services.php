          ...
          <div class="col-md-6 col-lg-3 ftco-animate" style="margin-bottom: 50px;">
            <div class="block-7">
              <div class="text-center">
                ...
                <span class="price"><sup>$</sup> <span class="number"><?php  echo htmlentities($row->ServicePrice);?></span></span>
                <p><?php  echo substr($row->SerDes,0,50);?></p>
                <a href="book_services.php?bookid=<?php echo $row->ID;?>" class="btn btn-danger px-4 py-3">Book</a>
              </div>
            </div>
          </div>
          <?php 
