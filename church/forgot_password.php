  ...
  { 
   ...
   if($password1 != $password2)
    ...
    }else
    {
      ...
      $sql ="SELECT email FROM church_users WHERE email=:email and phonenumber=:mobile";
      ...
      if($query -> rowCount() > 0)
      {
      $con="update church_users set password=:newpassword where email=:email and phonenumber=:mobile";
