    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="new_adpr_request.php">New Request</a></li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="reports">
                ...
                <li class="nav-item"> <a class="nav-link" href="feedback_adpr_report.php">FeedBack reports</a></li>
