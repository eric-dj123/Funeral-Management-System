      ...
      <li class="nav-item nav-profile dropdown">
        ...
        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
          ...
          <li class="nav-item dropdown">
            ...
            $sql ="SELECT parr_id from prayerrquest_tbl where status='0' AND religion='advantist' AND comment is null ORDER BY parr_id DESC";
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <div class="dropdown-divider"></div>
              <h6 class="p-3 mb-0 text-center"> <a href="new_advantist_request.php">See all new Payment</a></h6>
            </div>
          </li>
