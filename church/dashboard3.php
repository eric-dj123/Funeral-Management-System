            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white"style="height: 130px;">
                <div class="card-body" >
                  ...
                  <?php 
                  $sql ="SELECT parr_id from prayerrquest_tbl where comment is null AND religion='adpr'";
            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white"style="height: 130px;">
                <div class="card-body">
                  ...
                  <?php 
                  $sql ="SELECT parr_id from prayerrquest_tbl where comment is not null AND religion='adpr'";
                  $query = $dbh -> prepare($sql);
                  $query->execute();
                  $results=$query->fetchAll(PDO::FETCH_OBJ);
                  $totalnewbooking=$query->rowCount();
