            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="modal-header">
                  <h1 class="modal-title" style="float: left;">Report For Catholic Feedback</h1>    
                    ...
                    <div class="modal-dialog modal-xl">
                      <div class="modal-content">
                        ...
                        <div class="modal-body" id="info_update4">
                         <?php @include("view_newcatholicreport.php");?>
                       </div>
              ...
              <div class="card-body table-responsive p-3">
                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                  ...
                  <tbody>
                   ...
                   where religion='catholic' AND comment is not null";
                    $query = $dbh -> prepare($sql);
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {    
                        ...
                        <a href="invoice_generating_catholic.php?invid=<?php echo htmlentities ($row->parr_id);?>"><i class="mdi mdi-printer" aria-hidden="true"></i></a>
                      </td>
                        <?php 
                        $cnt=$cnt+1;
                      }
...
<script type="text/javascript">
  $(document).ready(function(){
    $(document).on('click','.edit_data4',function(){
      ...
      $.ajax({
        url:"view_newcatholicreport.php",
        type:"post",
