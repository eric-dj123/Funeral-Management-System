  ...
  <div class="container">
    <div class="row justify-content-center pb-5 mb-3">
      <div class="col-md-7 heading-section text-center ftco-animate">
        <h2>Choose Your Perfect Welcome Service </h2>
      </div>
    </div>
    <div class="row">
      <?php
     $sql="SELECT * from welcome_tbl";
      ...
      if($query->rowCount() > 0)
      {
        ...
        {  
          ?>
          <div class="col-md-6 col-lg-3 ftco-animate" style="margin-bottom: 10px;">
            <div class="block-7">
              <div class="text-center">
                <h4 class="heading-2"><h4 class="heading-2"><img class="img-fluid px-3 px-sm-0 mt-1 mb-1" style="width: 1005rem;"
                                            src="welcome/postimages/<?php echo $row->photo; ?>" alt="..."></h4></h4>
                <h4 class="heading-2"><?php  echo htmlentities($row->welcomename);?></h4>
                ...
                <a href="paywelcomeform.php?bookid=<?php echo $row->welcome_id;?>" class="btn btn-danger px-4 py-3">Continue</a>
              </div>
            </div>
          </div>
          <?php 
