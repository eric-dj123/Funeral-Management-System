  ...
  { 
   ...
   if($password1 != $password2)
    ...
    }else
    {
      ...
      $sql ="SELECT email FROM companyuser_tbl WHERE email=:email and phonenumber=:mobile";
      ...
      if($query -> rowCount() > 0)
      {
      $con="update companyuser_tbl set password=:newpassword where email=:email and phonenumber=:mobile";
