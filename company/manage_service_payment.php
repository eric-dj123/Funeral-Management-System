                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {    
                        ...
                        <tr>
                          ...
                          <a href="approve_payment_service.php?payserv=<?php echo ($row->payserv);?>" onclick="return confirm('Do you really want to Approve Received Money ?');" title="Block this User">Approve</a> </td>
    
                                              
                          </td>
                          <td class="text-center">
                          <a href="reject_payment_service.php?payserv=<?php echo ($row->payserv);?>" onclick="return confirm('Do you really want to Reject Not Receieved Money ?');" title="Block this User">Reject</a> </td>                      
                          </td>
