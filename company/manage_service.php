...
if(isset($_GET['delid']))
{
  ...
  $sql="delete from service_tbl where service_id=:rid";
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {    
                        ...
                        <tr>
                          ...
                          <td class="text-left"><?php  echo htmlentities($row->added_on);?></td>
                          <td class="text-left"><?php  echo htmlentities($row->description);?></td>
                          <td class="text-left">
                            <a href="#"  class=" edit_data" id="<?php echo  ($row->service_id); ?>" title="click for edit"><i class="mdi mdi-pencil-box-outline" aria-hidden="true"></i></a>
                            <a href="manage_service.php?delid=<?php echo ($row->service_id);?>" onclick="return confirm('Do you really want to Delete ?');"><i class="mdi mdi-delete" aria-hidden="true"></i></a>
                          </td>
