            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="modal-header">
                  <h5 class="modal-title" style="float: left;">Report Of Citizen Payment Service Approved</h5>    
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {    
                        ...
                        <tr>
                          ...
                          <a href="restoreapproveser.php?payserv=<?php echo ($row->payserv);?>" onclick="return confirm('Do you really want to Restore ?');" title="Block this User">Restore</a> </td>                      
                          </td>.
