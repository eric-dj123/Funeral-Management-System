...
if(isset($_POST['submit']))
{
  ...
  $sql="update service_tbl set servicename =:servicename,price=:price,description=:description where service_tbl.service_id=:eid";
...
<div class="card-body">
  ...
  <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
    <?php
    $eid=$_POST['edit_id'];
    $sql="SELECT * from  service_tbl where service_tbl.service_id=:eid";
    $query = $dbh -> prepare($sql);
    $query-> bindParam(':eid', $eid, PDO::PARAM_STR);
    $query->execute();
