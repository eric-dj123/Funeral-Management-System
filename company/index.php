...
if(isset($_POST['login']))
{
    ...
    $sql ="SELECT * FROM companyuser_tbl WHERE email=:email and password=:password";
    ...
    if($query->rowCount() > 0)
    {
        ...
        {
            $_SESSION['odmsaid']=$result->companyuser_id;
        ...
        $aa= $_SESSION['odmsaid'];
        $sql="SELECT * from companyuser_tbl  where companyuser_id=:aa";
        $query = $dbh -> prepare($sql);
                ...
                <div class="row flex-grow">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            ...
                            <img class="img-avatar" src="companyimages/deco1.jpg" alt="">
                                <h4 class="text-muted mt-4">
                                    Welcome to Company User Login Page
                                </h4>
                            </div>
