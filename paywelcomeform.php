...
$bid=$_GET['bookid'];
$stm=$conn->prepare("INSERT INTO `paymentwel_tbl`(`phonenumber`, `welcome_id`, `citizenuser_id`, `amount`) VALUES (?,?,?,?)");
		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-end">
				<div class="col-md-9 ftco-animate pb-5">
					...
					<h1 class="mb-0 bread">Pay Welcome</h1>
				</div>
			</div>
		</div>
	</section>
						...
						<div class="row no-gutters">
							<div class="col-md-7">
								<div class="contact-wrap w-100 p-md-5 p-4">
									<h3 class="mb-4">Pay Welcome Service Using MTN Number</h3>
