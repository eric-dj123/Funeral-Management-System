            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="modal-header">
                  <h5 class="modal-title" style="float: left;">Manage Payment Cemetery</h5>    
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {    
                        ...
                        <tr>
                          ...
                          <a href="approve_payment_cemetery.php?paycem_id=<?php echo ($row->paycem_id);?>" onclick="return confirm('Do you really want to Approve Received Money ?');" title="Block this User">Approve</a> </td>
    
                                              
                          </td>
                          <td class="text-center">
                          <a href="reject_payment_cemetery.php?paycem_id=<?php echo ($row->paycem_id);?>" onclick="return confirm('Do you really want to Reject Not Receieved Money ?');" title="Block this User">Reject</a> </td>                      
                          </td>
