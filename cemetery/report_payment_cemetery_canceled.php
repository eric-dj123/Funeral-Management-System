            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="modal-header">
                 <center> <h5 class="modal-title" style="float: left;">Report Of Citizen Payment Canceled </h5> </center>   
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {    
                        ...
                        <tr>
                          ...
                          <a href="restore.php?paycem_id=<?php echo ($row->paycem_id);?>" onclick="return confirm('Do you really want to Restore Payment ?');" title="Block this User">Restore</a> </td>
