  ...
  { 
   ...
   if($password1 != $password2)
    ...
    }else
    {
      ...
      $sql ="SELECT email FROM cemeteryuser_tbl WHERE email=:email and phonenumber=:mobile";
      ...
      if($query -> rowCount() > 0)
      {
      $con="update cemeteryuser_tbl set password=:newpassword where email=:email and phonenumber=:mobile";
